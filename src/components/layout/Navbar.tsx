...
export function Navbar() {
  ...
  // ✅ FIX: mounted state to prevent hydration error
    ...
    <nav className="sticky top-0 z-40 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-6">
            <Link href="/#features" className="text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600">
              Features
            </Link>
            <Link href="/#how-it-works" className="text-sm text-gray-600 dark:text-gray-400 hover:text-indigo-600">
              How It Works
            </Link>
      ...
      {mobileOpen && (
        <div className="md:hidden border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 px-4 py-4 space-y-3">
          ...
          <Link href="/#how-it-works" className="block text-sm text-gray-600 dark:text-gray-400">
            How It Works
          </Link>
